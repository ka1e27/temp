// THE WORLD MAP'S HEADER: the four figures, and the four ways off the screen.
//
...
// refreshes the four numbers on a 250ms timer and has to disable the buttons for
...
export function createWorldHeader({ meta, scenes, screens }) {
  ...
  // The fourth figure, and the only one that is a LIMIT rather than a balance —
